...
namespace AutosSystem.Controllers
{
    public class AutoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,VelocidadMaxima,Modelo")] Auto auto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,VelocidadMaxima,Modelo")] Auto auto)
        {
            if (id != auto.ID)
            {
                return NotFound();
